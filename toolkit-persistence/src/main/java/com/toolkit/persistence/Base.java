...
public abstract class Base {
	 ...
	 */
	public final static <T extends Base> void sort(List<T> list,
			String sortByClause) {
	 ...
	 *            the id value
	 */
	public final static <T extends Base> T find(Class<T> beanType, Object id) {
		return Ebean.find(beanType, id);
	}
	
	public final static <T extends Base> T findById(Class<T> beanType, Object id) {
		return Ebean.find(beanType, id);
	}
	 ...
	 *            the name of the query
	 */
	public final static <T extends Base> Query<T> createNamedQuery(
	 ...
	 *            the object query
	 */
	public final static <T extends Base> Query<T> createQuery(
	 ...
	 * </pre>
	 */
	public final static <T extends Base> Update<T> createNamedUpdate(
	 ...
	 * </pre>
	 */
	public final static <T extends Base> Update<T> createUpdate(
	 ...
	 */
	public final static <T extends Base> CsvReader<T> createCsvReader(
			Class<T> beanType) {
	 ...
	 */
	public final static <T extends Base> Query<T> createQuery(Class<T> beanType) {
	 ...
	 * @return A ORM Query object for this beanType
	 */
	public final static <T extends Base> Query<T> find(Class<T> beanType) {
	 ...
	 * </p>
	 */
	public final static <T extends Base> Filter<T> filter(Class<T> beanType) {
	 ...
	 * 
	 */
	public final static <T extends Base> T execute(TxScope scope,
			TxCallable<T> c) {
	 ...
	 * </pre>
	 */
	public final static <T extends Base> T execute(TxCallable<T> c) {
